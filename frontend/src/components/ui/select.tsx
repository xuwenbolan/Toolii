...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground transition-[border-color,background-color,box-shadow] duration-[var(--duration-fast)] ease-[var(--ease-out)] focus:outline-none focus:border-ring/60 focus:ring-2 focus:ring-ring/40 focus:shadow-[0_0_0_3px_rgba(14,165,233,0.08)] disabled:cursor-not-allowed disabled:opacity-50",
      className
    )}
    {...props}
  >
