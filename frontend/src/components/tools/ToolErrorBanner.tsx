...
export function ToolErrorBanner({ error, errorMeta, onRetry, className }: Props) {
  ...
  return (
    <div className={cn('rounded-xl border px-3 py-2.5 motion-safe:animate-[shake_0.3s_var(--ease-out),section-in_0.25s_var(--ease-out)_both]', toneClassMap[visual.tone as BannerTone], className)}>
